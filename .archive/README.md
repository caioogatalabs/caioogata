...
**2026-09-09:** `next-builds/` (1.0 GB of `.next.bak.*` build output) deleted — regenerable via `cd site && pnpm build`. Everything remaining here is hand-made and irreplaceable.
